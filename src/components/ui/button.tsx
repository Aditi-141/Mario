...
const buttonVariants = cva(
  "cursor-pointer rounded-xl border border-white/20 bg-white/10 px-3 py-2.5 font-bold text-white",
  {
    variants: {
      variant: {
...
function Button({
  ...
  return (
    <Comp
      ...
      data-size={size}
      className="cursor-pointer rounded-xl border border-white/20 bg-white/10 px-3 py-2.5 font-bold text-white"
      {...props}
    />
  )
}
